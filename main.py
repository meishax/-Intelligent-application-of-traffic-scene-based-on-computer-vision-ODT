...
ap.add_argument("-i", "--input", help="path to input video", default="./test_video/video-02.mp4")
...
def main(yolo):
    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            list_file.write('\n')
            # list_file.write(str(track.track_id)+',')
            cv2.putText(frame, str(" "), (int(bbox[0]), int(bbox[1] - 50)), 0, 5e-3 * 150, (color), 2)
            if len(class_names) > 0:
                class_name = class_names[0]
                cv2.putText(frame, str("car or person"), (int(bbox[0]), int(bbox[1] - 20)), 0, 5e-3 * 150, (color), 2)
        ...
        cv2.putText(frame, "Total Flow Counter: " + str(count+1), (int(20), int(120)), 0, 5e-3 * 200, (0, 255, 0),
                    2)
        cv2.putText(frame, "Current Flow Counter: " + str(i+1), (int(20), int(80)), 0, 5e-3 * 200, (0, 255, 0), 2)
